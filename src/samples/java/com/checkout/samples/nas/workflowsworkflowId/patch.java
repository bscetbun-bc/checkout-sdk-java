...
public class patch {
    ...
    public static void main(final String[] args) throws ExecutionException, InterruptedException {
        ...
        try {
            final UpdateWorkflowRequest request = UpdateWorkflowRequest.builder()
                    .name("")
                    .build();

            final UpdateWorkflowResponse response = api.workflowsClient().updateWorkflow("workflowId", request).get();
