package com.checkout.samples.nas.paymentsidcaptures;// For more information please refer to https://github.com/checkout/checkout-sdk-java
    ...
    public static void main(final String[] args) throws ExecutionException, InterruptedException {
        ...
        try {
            final CaptureRequest captureRequest = CaptureRequest.builder()
                    ...
                    .build();
            final CaptureResponse response = api.paymentsClient().capturePayment("paymentId", captureRequest).get();
