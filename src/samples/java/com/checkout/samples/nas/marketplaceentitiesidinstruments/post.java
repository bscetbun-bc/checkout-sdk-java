package com.checkout.samples.nas.marketplaceentitiesidinstruments;// For more information please refer to https://github.com/checkout/checkout-sdk-java
...
public class post {
    ...
    public static void main(final String[] args) throws ExecutionException, InterruptedException {
        ...
        try {
            final MarketplacePaymentInstrument marketplacePaymentInstrument = MarketplacePaymentInstrument.builder().build();
            api.marketplaceClient().createPaymentInstrument(marketplacePaymentInstrument, "entityId").get();
