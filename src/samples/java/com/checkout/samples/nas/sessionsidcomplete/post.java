package com.checkout.samples.nas.sessionsidcomplete;// For more information please refer to https://github.com/checkout/checkout-sdk-java
...
public class post {
    ...
    public static void main(final String[] args) throws ExecutionException, InterruptedException {
        ...
        try {
            api.sessionsClient().completeSession("sessionId").get();
