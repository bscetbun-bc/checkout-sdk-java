package com.checkout.samples.nas.workflowseventseventIdworkflowworkflowIdreflow;// For more information please refer to https://github.com/checkout/checkout-sdk-java
...
public class post {
    ...
    public static void main(final String[] args) throws ExecutionException, InterruptedException {
        ...
        try {
            final ReflowResponse response = api.workflowsClient().reflowByEventAndWorkflow("eventId", "workflowId").get();
